import { ChatInputType, ComponentSpecs, ProjectSpecs } from '@/apis';
...
export const ReviewProjectSpecs: React.FC<ProjectSpecsProps> = ({ projectSpecs, onSubmitIssue, setProjectSpecs }) => {
  ...
  return (
    <div className='px-6 py-4'>
      ...
      <div className='p-3' />
      <ImageChatInput onSend={handleSubmit} sendOnEmpty={true} placeholder="Your issues, leave empty if none" />
    </div>
  );
};
